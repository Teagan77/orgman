...
public class GenderFactory {
    ...
    private static final String SUFFIX = getSuffixFromClassName(GenderFactory.class); // Expecting GF from (G)ender(F)actory.

    public static Gender buildGender(String genderDescription) {
        return new Gender.Builder()
                .genderId(SUFFIX + UUID.randomUUID().toString())
